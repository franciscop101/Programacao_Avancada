...
class FragmentListaService : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> =
        CursorLoader(
            requireContext(),
            ContentProviderAppointment.ENDERECO_SERVICE,
            TabelaBDService.TODAS_COLUNAS,
            null,
            null,
            "${TabelaBDService.CAMPO_SERVICE_TYPE}"
        )
