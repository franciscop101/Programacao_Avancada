...
class AdapterService (val fragment: FragmentListaService) : RecyclerView.Adapter<AdapterService.ViewHolderService>() {
    ...
    var viewHolderSelecionado : ViewHolderService? = null
    ...
    inner class ViewHolderService(itemService: View) : RecyclerView.ViewHolder(itemService), View.OnClickListener {
        ...
        private fun seleciona() {
            ...
            fragment.serviceSeleccionado = services
        }
    ...
    override fun onBindViewHolder(holder: ViewHolderService, position: Int) {
        ...
        holder.services = Services.fromCursor(cursor!!)
    }
