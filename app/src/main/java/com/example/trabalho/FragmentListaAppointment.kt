...
class FragmentListaAppointment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var _binding: FragmentListaAppointmentBinding? = null
    private var adapterAppointment : AdapterAppointment? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListaAppointmentBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerViewAppintment.layoutManager = LinearLayoutManager(requireContext())
    ...
    override fun onLoadFinished(loader: Loader<Cursor>, data: Cursor?) {
        adapterAppointment!!.cursor = data
    }
    ...
    override fun onLoaderReset(loader: Loader<Cursor>) {
        ...
        adapterAppointment!!.cursor = null
    }

    fun processaOpcaoMenu(item: MenuItem) : Boolean =
        when(item.itemId) {
            R.id.action_inserir -> {
                val acao = FragmentListaAppointmentDirections.actionFragmentListaAppointmentToFragmentEditarAppointment()
                findNavController().navigate(acao)
                (activity as MainActivity).atualizaName(R.string.inserir_appointment_label)
                true
            }
            R.id.action_alterar -> {
    ...
    companion object {
        const val ID_LOADER_APPOINTMENT = 0
    }
}