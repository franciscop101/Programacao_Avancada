...
class AdapterAppointment (val fragment: FragmentListaAppointment) : RecyclerView.Adapter<AdapterAppointment.ViewHolderAppointment>() {
    ...
    inner class ViewHolderAppointment(itemAppointment: View) : RecyclerView.ViewHolder(itemAppointment), View.OnClickListener {
        ...
        init {
            itemAppointment.setOnClickListener(this)
        }

        var appointment : Appointment? = null
            get() = field
            set(value: Appointment?) {
                field = value
        ...
        private fun seleciona() {
            ...
            fragment.appointmentSeleccionado = appointment
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderAppointment {
        val itemAppointment = fragment.layoutInflater.inflate(R.layout.item_appointment, parent, false)
        return ViewHolderAppointment(itemAppointment)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolderAppointment, position: Int) {
        ...
        holder.appointment = Appointment.fromCursor(cursor!!)
    }
